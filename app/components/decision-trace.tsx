    ...
    <div className="p-5 rounded-2xl glass-panel border border-slate-800 shadow-xl flex flex-col justify-between h-full">
      <div>
        ...
        <div className="p-3.5 rounded-xl bg-slate-950/80 border border-slate-700/80 mb-4">
          ...
          {/* Candidate Utility Score Breakdown */}
          {trace.candidateAction && trace.rankedCandidates && trace.rankedCandidates.length > 0 && (
            <div className="mt-3 pt-2.5 border-t border-slate-800/80">
              ...
              <div className="grid grid-cols-2 gap-2 text-[10px] font-mono">
                <div className="p-1.5 rounded bg-slate-900 border border-slate-800 flex justify-between">
                  ...
                  <span className="text-cyan-300 font-bold">{trace.selectedUtility.toFixed(2)}</span>
                </div>
                <div className="p-1.5 rounded bg-slate-900 border border-slate-800 flex justify-between">
                  <span className="text-slate-400">Intrusion Cost:</span>
                  <span className="text-amber-300 font-bold">{trace.intrusionCost.toFixed(2)}</span>
                </div>
              </div>
            </div>
          )}
